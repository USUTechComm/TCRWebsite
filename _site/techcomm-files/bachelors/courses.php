...
<html lang="en">
    ...
    <body>
        ...
        <!-- HEADER -->
        <?php $page1->addHeader(bachelors,courses); ?>
        ...
        <main>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <article class="col-xs-12 col-sm-9">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="page-header">
                                <h1><small><?= $bachelors["title"] ?></small><br><?= $bachelors["courses"]["title"] ?></h1>
                            </div>
                        ...
                        <section class="col-xs-12">
                            ...
                            <h3><small>ENGL 5400: Specialized Documents </small><br>Social Media and Community Based Marketing</h3>
                            <p>Dr. John McLaughlin</p>
                            <p>Social media isn't new. The only thing "new" about it is the technology. From Roman times until the modern era, social media has been a driving factor behind the dissemination of social, political, religious, and scientific information outside the normal, official routes of communication. From graffiti discovered on the walls of Pompeii ("I made a great soup today") to the Facebook posts and Twitter tweets that fueled the Arab Spring in the Middle East and Euromaidan in Ukraine ("Everyone get to Maidan now!"), social media has driven change. Social media also becomes a key factor in the formation of communities of interest such as that formed and maintained by the Grateful Dead for 50 years. The ways that social media and communities of interest interact with marketing were examined in this course.</p>
                        ...
                        <section class="col-xs-12">
                            ...
                            <h3><small>ENGL 5490: Special Topics in Professional and Technical Writing</small><br>Ethics and Culture in Technical Communication</h3>

                            <p>Dr. Jared Colton</p>

                            <p>As Michael Martin has astutely noted, a national survey conducted a couple years before the 2008 economic recession stated that, “only slightly more than a third [of businesses] use any type of formal ethics training." One way to counter this lack of oversight and accountability in the workplace is to create awareness of ethics in (future) technical communicators through discussion and instruction in the classroom.</p>

                            <p>In this course, students will be exposed to and discuss a number of theories, arguments, and case studies about and for ethics in technical communication, including deontology, virtue, consequentialism, as well as various postmodern and cultural studies perspectives. The perennial exigency for interrogating ethical paradigms remains in the following questions: what kinds of ethics should future technical communicators have, how do/should they come to construct and understand ethical values, and how do/should they practice these ethical values? The goal of this course is to continually interrogate these questions by understanding different situations through the various ethical frameworks we learn about and research. By the end of this course, students should be able to make a strong case for ethics in technical communication, have improved their ability to analyze the ethics of rhetorical situations, and understand how to better approach such situations in their current and future careers as technical communicators.</p>
                        ...
                        <section class="col-xs-12">
                            ...
                            <h3><small>ENGL 5410: Studies in Digital Media Production</small><br>Responsive Web Design &amp; Technical Communication</h3>
                            <p>Dr. Rebecca Walton</p>

                            <p>This course will equip you with skills, problem-solving strategies, and relevant concepts for developing professional communication that can be viewed on devices with a range of screen sizes, including mobile devices. You will leave this course able to articulate what the rising trend of mobile computing has to do with technical communication, able to argue against extreme positions of technophobe and technophile, able to evaluate what makes an effective and well-designed mobile site, and able to develop responsive websites that can be used and viewed on a range of devices. If you work hard, by the end of the semester, you will be equipped with these abilities and have a portfolio piece to prove them to potential employers.</p>
                            <p>You will develop skills in responsive web design. You will also develop skills in working with clients to inform the development of professional communication that best meets their needs. You will develop competencies in writing succinctly, in summarizing and signposting content, and in working with a team. You will develop points of view that can inform your professional identity as a technical communicator: e.g., understanding the role of technical communicators in web design, content creation, communication strategy, and other professional communication activities that are vital to organizations like businesses and nonprofit organizations.</p>

                            <h3><small>ENGL 5490</small><br>Game Usability</h3>
                            <p>Dr. Ryan Moeller</p>

                            <p>This course is designed to prepare you to work in multiple roles as a usability tester and to understand the industry trends surrounding usability in product design. This course is designed to address the following objectives of the professional and technical writing emphasis area.</p>

                            <p>Students will know about basic concepts and procedures for usability testing and games user research The importance of teamwork in the profession.</p>
                    ...
                    <!-- SIDE MENU -->
                    <?php $page1->addSideMenu(bachelors,courses) ?>
